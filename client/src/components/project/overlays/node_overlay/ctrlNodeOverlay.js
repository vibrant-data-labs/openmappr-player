angular.module('common')
    ...
    **************************************/
            ...
            function getLinkIcon(url) {
                ...
                if (url.includes('candid.org')) return '/img/candid_icon.jpg';
                if (url.includes('guidestar.org')) return '/img/guidestar.svg';
                if (url.includes('youtube.com')) return '/img/youtube.svg';
                if (url.includes('vimeo.com')) return '/img/vimeo.svg';
