...
.controller('artifactUploadCtrl', ['$scope', 'Upload', '$q', '$uibModalInstance','recipeService', 'orgFactory', 'uiService',
function($scope, Upload, $q, $uibModalInstance, recipeService, orgFactory, uiService) {
    'use strict';
    //
