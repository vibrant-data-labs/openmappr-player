...
.directive('dirDatasetPostProcPhase', ['phaseService',
function(phaseService) {
    ...
    **************************************/
    var dirDefn = {
        restrict: 'AE',
        templateUrl: '#{server_prefix}#{view_path}/components/dashboard/recipes/phase_modals/phase_dataset_post_proc.html',
        scope: {
            phasevm: '=',
            recipevm: '='
        },
