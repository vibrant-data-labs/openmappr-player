...
function getKeyAttributes(key) {
  ...
  var result = Object.assign({}, key);
  result.maxRanking = Infinity;
  result.minRanking = -Infinity;
  return result;
}


onmessage = function(e) {
    const [ allNodes, filterAttrIds, searchValue ] = e.data;
    const keys = filterAttrIds.map(r => 'attr.' + r);
    const data = matchSorter(allNodes, searchValue, { keys: keys, threshold: 3 });
