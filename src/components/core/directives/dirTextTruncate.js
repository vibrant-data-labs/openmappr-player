//modified from: https://github.com/lorenooliveira/ng-text-truncate
//added less at top as well as bottom when all text is showing
(function() {
'use strict';
	...
	.directive( "ngTextTruncate", [ "$compile", "ValidationServices", "CharBasedTruncation", "WordBasedTruncation",
        ...
        return {
            ...
            link: function( $scope, $element, $attrs ) {
				...
				// console.debug('ngTextTruncate text: ', $scope.text);
            ...
            applyTruncation: function( threshould, $scope, $element ) {
                if( $scope.useToggling ) {
                    var el = angular.element(    "<span>" +
                                                    ...
                                                    "<span class='btn-link truncate-toggle-text' " +
                                                        "ng-click='toggleShow()'" +
                                                        "ng-show='!open'>" +
                                                    ...
                                                    "<span ng-show='open'>" +
                                                        ...
                                                        // "<span class='btn-link truncate-toggle-text top-less'" +
                                                        //       "ng-click='toggleShow()'>" +
